_skiprhythmtest equ 1				; Skips the Rhythm Test when you don't have a save file.
_debug equ 1						; Various Debug hacks, unlock everything, etc...
_oamluaconsolemessages equ 0		; Logs OAM loads in RAM (for the gfxLocator.lua script)
_spriteluaconsolemessages equ 0		; Logs Sprite loads in RAM (for the gfxLocator.lua script)
